...
agentSettings.maxVelocity = 0.008;
agentSettings.maxSteeringForce = 8;
agentSettings.trailAvoidDist = 0.03;
agentSettings.trailDropDelay = 0.015;
...
function createAgent(scene) {
	...
	agent.currentPosition = new THREE.Vector3();
	...
	agent.numTrailSegments = agentSettings.numTrailSegments;

	agent.trailSegments = [];
	agent.trailSegments.length = agentSettings.numTrailSegments;
